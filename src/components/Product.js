    ...
    <div className="product">
      <div className="product__details">
        ...
        <div className="product__overview">
          ...
          <p>
            {item.description}
            Wind long sleeve t-shirt for men and women, loose form unisex
            oversize ulzzang GIRL CRUSH long sleeve t-shirt 3006
          </p>
        </div>
        ...
        <div className="product__order">
          ...
          <p>
            <small>Ships from</small> Fall Shop
          </p>
          <p>
            <small>Sold by</small> Fall Shop
          </p>
